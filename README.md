...
| Document | Contingut |
|---|---|
| [`Docs/Documentació_Completa.md`](Docs/Documentació_Completa.md) | Documentació tècnica completa: CPD físic, infraestructura IT, elèctrica, càlculs SAI, tots els serveis |
